...
const SvgOrganization = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M6.75 9a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5zM8.75 9.75A.75.75 0 0 1 9.5 9h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1-.75-.75M9.5 6.5a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5zM6 7.25a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 0 1.5h-.5A.75.75 0 0 1 6 7.25" />
    <path
      fillRule="evenodd"
