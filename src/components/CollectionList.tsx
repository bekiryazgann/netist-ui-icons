...
const SvgCollectionList = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path d="M11.75 6.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0m-.25 7.25a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75m0 3a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75" />
  </svg>
);
