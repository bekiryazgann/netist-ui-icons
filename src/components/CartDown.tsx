...
const SvgCartDown = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path d="M12 3.75a.75.75 0 0 0-1.5 0v3.69L9.28 6.22a.75.75 0 0 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l2.5-2.5a.75.75 0 0 0-1.06-1.06L12 7.44zM10 17a1 1 0 1 1-2 0 1 1 0 0 1 2 0m5 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0" />
  </svg>
);
export default SvgCartDown;
