...
const SvgInventoryUpdated = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path d="M13.28 10.28a.75.75 0 0 0-1.06-1.061l-2.97 2.97-1.22-1.22a.75.75 0 1 0-1.06 1.06l1.75 1.75a.75.75 0 0 0 1.06 0z" />
  </svg>
);
export default SvgInventoryUpdated;
