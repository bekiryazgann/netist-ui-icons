...
const SvgProductRemove = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path d="M14 7a1 1 0 1 1-2 0 1 1 0 0 1 2 0M12.25 12.25a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5z" />
  </svg>
);
export default SvgProductRemove;
