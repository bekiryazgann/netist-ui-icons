...
const SvgProductReference = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M14 7a1 1 0 1 1-2 0 1 1 0 0 1 2 0M16.78 15.72a.75.75 0 0 1-1.06 1.06l-2.22-2.22v1.19a.75.75 0 0 1-1.5 0v-3a.75.75 0 0 1 .75-.75h3a.75.75 0 1 1 0 1.5h-1.19z" />
  </svg>
);
