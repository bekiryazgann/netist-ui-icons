...
const SvgDockFloating = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M11 10a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1z" />
    <path
      fillRule="evenodd"
...
export default SvgDockFloating;
