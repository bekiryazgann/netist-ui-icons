...
const SvgCollection = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M13.75 3.25A.75.75 0 0 0 13 2.5H9.971c-.87 0-1.703.348-2.313.968L2.966 8.223a.75.75 0 0 0 1.067 1.054l4.693-4.756A1.75 1.75 0 0 1 9.971 4H13a.75.75 0 0 0 .75-.75m-1 6.25a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
    <path
      fillRule="evenodd"
