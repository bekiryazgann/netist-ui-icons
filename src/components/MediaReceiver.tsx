...
const SvgMediaReceiver = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M9.25 4a.75.75 0 0 1 .75-.75A5.75 5.75 0 0 1 15.75 9a.75.75 0 0 1-1.5 0A4.25 4.25 0 0 0 10 4.75.75.75 0 0 1 9.25 4M6.75 12.75a.75.75 0 0 0 0 1.5h2a.75.75 0 0 0 0-1.5z" />
    <path
      fillRule="evenodd"
