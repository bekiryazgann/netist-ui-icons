...
const SvgProductList = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M12.448 7.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2M11 12.75a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75M11 15.75a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1-.75-.75" />
  </svg>
);
