...
const SvgProductCost = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M14 7a1 1 0 1 1-2 0 1 1 0 0 1 2 0M13.25 10.857a1.876 1.876 0 0 0 .625 3.643h.75a.375.375 0 0 1 0 .75H12.75a.75.75 0 0 0 0 1.5h.5V17a.75.75 0 0 0 1.5 0v-.254A1.875 1.875 0 0 0 14.625 13h-.75a.375.375 0 0 1 0-.75h1.875a.75.75 0 0 0 0-1.5h-1v-.25a.75.75 0 0 0-1.5 0z" />
  </svg>
);
