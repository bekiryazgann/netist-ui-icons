...
const SvgWand = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path d="M14.25 12a.75.75 0 0 1 .75.75v.75h.75a.75.75 0 0 1 0 1.5H15v.75a.75.75 0 0 1-1.5 0V15h-.75a.749.749 0 1 1 0-1.5h.75v-.75a.75.75 0 0 1 .75-.75M5.75 3.5a.75.75 0 0 1 .75.75V5h.75a.75.75 0 0 1 0 1.5H6.5v.75a.75.75 0 0 1-1.5 0V6.5h-.75a.75.75 0 1 1 0-1.5H5v-.75a.75.75 0 0 1 .75-.75" />
  </svg>
);
