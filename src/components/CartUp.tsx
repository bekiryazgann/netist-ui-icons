...
const SvgCartUp = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M12 9.25a.75.75 0 0 1-1.5 0V5.56L9.28 6.78a.75.75 0 0 1-1.06-1.06l2.5-2.5a.75.75 0 0 1 1.06 0l2.5 2.5a.75.75 0 0 1-1.06 1.06L12 5.56zM10 17a1 1 0 1 1-2 0 1 1 0 0 1 2 0m5 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0" />
  </svg>
);
