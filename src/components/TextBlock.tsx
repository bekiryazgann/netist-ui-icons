...
const SvgTextBlock = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M7.25 6.5a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5zM6.5 10a.75.75 0 0 1 .75-.75h5.5a.75.75 0 0 1 0 1.5h-5.5A.75.75 0 0 1 6.5 10M7.25 12a.75.75 0 0 0 0 1.5h3.5a.75.75 0 0 0 0-1.5z" />
    <path
      fillRule="evenodd"
