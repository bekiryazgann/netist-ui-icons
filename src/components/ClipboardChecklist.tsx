...
const SvgClipboardChecklist = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M8.75 10.25a1 1 0 1 1-2 0 1 1 0 0 1 2 0M7.75 14.25a1 1 0 1 0 0-2 1 1 0 0 0 0 2M9.75 10.25a.75.75 0 0 1 .75-.75h2a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1-.75-.75M10.5 12.5a.75.75 0 0 0 0 1.5h2a.75.75 0 0 0 0-1.5z" />
    <path
      fillRule="evenodd"
