...
const SvgDataPresentation = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M13.5 6.75a.75.75 0 0 0-1.5 0v3.5a.75.75 0 0 0 1.5 0zM7.25 8.5a.75.75 0 0 1 .75.75v1a.75.75 0 0 1-1.5 0v-1a.75.75 0 0 1 .75-.75m3.5-.5a.75.75 0 0 0-1.5 0v2.25a.75.75 0 0 0 1.5 0z" />
    <path
      fillRule="evenodd"
