...
const SvgTextGrammar = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path d="M3.5 13.25a.75.75 0 0 1 .75-.75h10a.75.75 0 0 1 0 1.5h-10a.75.75 0 0 1-.75-.75M3.5 15.75a.75.75 0 0 1 .75-.75h5a.75.75 0 0 1 0 1.5h-5a.75.75 0 0 1-.75-.75" />
    <path
      fillRule="evenodd"
