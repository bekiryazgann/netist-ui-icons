...
const SvgReceiptRefund = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M13.25 11.25a.75.75 0 0 1-1.5 0v-.5A1.75 1.75 0 0 0 10 9h-.94l.72.72a.75.75 0 0 1-1.06 1.06l-2-2a.75.75 0 0 1 0-1.06l2-2a.75.75 0 0 1 1.06 1.06l-.72.72H10a3.25 3.25 0 0 1 3.25 3.25z" />
    <path
      fillRule="evenodd"
