...
const SvgGames = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M13 8.25a1 1 0 1 1-2 0 1 1 0 0 1 2 0m.75 3.25a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-6.5-4.25A.75.75 0 0 1 8 8v.5h.5a.75.75 0 0 1 0 1.5H8v.5a.75.75 0 0 1-1.5 0V10H6a.75.75 0 0 1 0-1.5h.5V8a.75.75 0 0 1 .75-.75" />
    <path
      fillRule="evenodd"
