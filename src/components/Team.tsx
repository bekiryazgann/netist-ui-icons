...
const SvgTeam = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M6 4a2.25 2.25 0 1 0 0 4.5A2.25 2.25 0 0 0 6 4m-.75 2.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0M10 7a2.25 2.25 0 1 0 0 4.5A2.25 2.25 0 0 0 10 7m-.75 2.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0M11.75 6.25a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0M14 5.5A.75.75 0 1 0 14 7a.75.75 0 0 0 0-1.5"
    />
