...
const SvgThemeEdit = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path d="M17.03 12.371a.5.5 0 0 0 0-.707l-1.06-1.06a.5.5 0 0 0-.708 0l-.957.957 1.768 1.767zm-1.664 1.664-1.768-1.767-2.45 2.449a2 2 0 0 0-.585 1.407l-.002.698a.25.25 0 0 0 .25.25l.698-.002a2 2 0 0 0 1.408-.586z" />
  </svg>
);
