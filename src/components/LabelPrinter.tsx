...
const SvgLabelPrinter = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M14 6.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0m-7.25-.75a.75.75 0 0 0 0 1.5h3a.75.75 0 0 0 0-1.5zM8.5 13.5a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 0 1.5h-1.5a.75.75 0 0 1-.75-.75m.75-3.25a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5z" />
    <path
      fillRule="evenodd"
