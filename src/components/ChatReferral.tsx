...
const SvgChatReferral = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path d="M13.75 4a.75.75 0 0 0 0 1.5h.69l-3.22 3.22a.75.75 0 0 0 1.06 1.06l3.22-3.22v.69a.75.75 0 0 0 1.5 0v-2.5a.75.75 0 0 0-.75-.75z" />
  </svg>
);
export default SvgChatReferral;
